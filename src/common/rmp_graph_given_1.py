...
class RMP_graph_given_l:
    ...
    def __init__(self,my_Multi_Graph_Object,resStates_minus_by_node:Dict[int,Set[State]],res_actions,dominated_action,the_null_action,action_id_2_actions,jy_option):
        ...
        if self.jy_option['debug'] == True:
            with TimeProfiler(self.time_profile, "rmp:debug_init"):
    ...
    def make_state_id_2_state(self):
        with TimeProfiler(self.time_profile, "rmp:make_state_id_2_state"):
    ...
    def initialize_system(self):
        #initialize teh RMP graphwith TimeProfiler(self.time_profile, "rmp:make_state_id_2_state"):
        with TimeProfiler(self.time_profile, "rmp:initialization"):
            with TimeProfiler(self.time_profile, "rmp:make_state_id_2_state"):

                self.make_state_id_2_state()

            for u in self.nodes:#self.my_Multi_Graph_Object.resStates_minus_by_node:
                with TimeProfiler(self.time_profile, "rmp:update_domination"):

                    self.update_domination(u) #grab domination list and dominated list for each u

                with TimeProfiler(self.time_profile, "rmp:RMP_update_sub_compute_min_dominating_states_by_node"):
                    self.RMP_update_sub_compute_min_dominating_states_by_node(u)#update minimum domination dictionary


                with TimeProfiler(self.time_profile, "rmp:RMP_update_sub_compute_maximum_dominated_states_by_node"):
            ...
            # if self.jy_option['debug'] == True:
            #     with TimeProfiler(self.time_profile, "rmp:debug_check_actions_ok"):
            #         self.debug_check_actions_ok()
            with TimeProfiler(self.time_profile, "rmp:RMP_clean_states_EZ"):
                ...
                #if a1 in self.deb
            with TimeProfiler(self.time_profile, "rmp:RMP_make_null_actions"):

                self.RMP_make_null_actions()

            with TimeProfiler(self.time_profile, "rmp:RMP_compute_remove_redundant_actions"):
                self.RMP_compute_remove_redundant_actions()

            with TimeProfiler(self.time_profile, "rmp:RMP_make_equiv_classes"):
    ...
    def update_domination(self, my_node):
        ...
        with TimeProfiler(self.time_profile, "rmp:update_domination_inner"):
    ...
    def RMP_update_sub_compute_maximum_dominated_states_by_node(self,my_node):
        ...
        with TimeProfiler(self.time_profile, "rmp:RMP_update_sub_compute_maximum_dominated_states_by_node_inner"):
    ...
    def RMP_update_sub_compute_min_dominating_states_by_node(self, my_node):
        with TimeProfiler(self.time_profile, "rmp:RMP_update_sub_compute_min_dominating_states_by_node_inner"):
    ...
    def RMP_compute_remove_redundant_actions(self):
        ...
        with TimeProfiler(self.time_profile, "rmp:RMP_compute_remove_redundant_actions_inner"):
    ...
    def RMP_make_null_actions(self):  
        with TimeProfiler(self.time_profile, "rmp:RMP_make_null_actions_inner"):
    ...
    def DEBUG_RMP_clean_states_EZ(self,a1:Action):
        ...
        with TimeProfiler(self.time_profile, "rmp:DEBUG_RMP_clean_states_EZ"):
    ...
    def RMP_clean_states_EZ(self,a1:Action):
        """Cleans and updates non-dominated actions for each action in the problem."""
        with TimeProfiler(self.time_profile, "rmp:RMP_clean_states_EZ_inner"):
            # Initialize defaultdicts once per action
    ...
    def RMP_make_equiv_classes(self):
        ...
        with TimeProfiler(self.time_profile, "rmp:RMP_make_equiv_classes_inner"):

...
class RMP_graph_given_l:
    ...
    def __init__(self,my_Multi_Graph_Object,resStates_minus_by_node,res_actions,nullAction):
        self.my_Multi_Graph_Object=my_Multi_Graph_Object#provides the multigrpah object for the l\in Omega_R generating this. 
        ...
        self.nullAction=nullAction # null action
    ...
    def RMP_clean_states_EZ(self,a1):
        ...
        for s_head in action_ub_head_tail & head_in_prob: #get all heads in the problem and can be the product of the action
